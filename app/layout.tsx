        ...
        <ThemeProvider>
          ...
          <footer className="relative mx-auto w-full max-w-[90%] pb-12">
            <Section
              ...
              background="default"
              className="w-full"
              containerClassName="max-w-6xl flex flex-col gap-6 py-8 text-center md:flex-row md:items-center md:justify-between md:text-left"
            >
              ...
              <div className="flex flex-wrap justify-center gap-3 md:justify-end">
                <a
                  ...
                  aria-label="Email"
                  className="group inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/5 text-slate-900 transition hover:border-white/30 hover:bg-white/15 dark:text-white"
                >
                  <svg
                    width="18"
                    height="18"
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  className="group inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/5 text-blue-600 transition hover:border-white/30 hover:bg-white/15 dark:text-blue-400"
                >
                  <svg
                    width="18"
                    height="18"
