...
export default function Sidebar({ socialLinks }: SidebarProps) {
  ...
  const toggleSidebar = () => {
    ...
    setIsOpen(!isOpen);
    console.log('Sidebar state should be:', !isOpen);
  };
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-6 left-6 z-50 p-2 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:scale-105 lg:top-8 lg:left-8"
      ...
      <div
        id="sidebar"
        className={`fixed top-0 left-0 h-full w-80 bg-white dark:bg-gray-900 shadow-2xl z-40 transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="p-6 border-t border-gray-200 dark:border-gray-700 space-y-3">
            ...
            <div className="flex space-x-2">
              <a
                ...
                title="Email"
              >
                <svg className="w-4 h-4 text-white group-hover:text-gray-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                title="LinkedIn"
              >
                <svg className="w-4 h-4 text-white group-hover:text-gray-100" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                title="GitHub"
              >
                <svg className="w-4 h-4 text-white dark:text-gray-900 group-hover:text-gray-200 dark:group-hover:text-gray-700" fill="currentColor" viewBox="0 0 24 24">
